...
router.get('/portal/meetings', controller.getCommitteePortalMeetings);
router.get('/portal/meetings/:id', controller.getCommitteePortalMeetingById);
router.get('/portal/meetings/:id/attendance', controller.getCommitteePortalMeetingAttendance);
router.post('/portal/meetings/:id/attendance', controller.saveCommitteePortalMeetingAttendance);
router.post('/portal/meetings', controller.createCommitteePortalMeeting);
router.put('/portal/meetings/:id', controller.updateCommitteePortalMeeting);
router.delete('/portal/meetings/:id', controller.deleteCommitteePortalMeeting);
